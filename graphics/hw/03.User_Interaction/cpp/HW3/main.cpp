...
void compose_imgui_frame()
{
  ...
  // control window
  {
    ...
    ImGui::SliderFloat3("scale", &g_vec_model_scale[0], 0.f, 3.0f);
...
void set_transform() 
{
  ...
  glm::mat4 g_mat_translate = glm::translate(g_vec_model_translate);
  glm::mat4 g_mat_rotate = glm::mat4_cast(g_quat_model_rotation);
  glm::mat4 g_mat_scale = glm::scale(g_vec_model_scale);

  g_mat_model = g_mat_scale * g_mat_rotate * g_mat_translate;
}
