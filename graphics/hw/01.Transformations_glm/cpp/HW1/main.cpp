...
void glm_mat_test() {
  ...
  A[0][0] = 1;  A[1][0] = 2;  A[2][0] = -1;  A[3][0] = -1;
  A[0][1] = 2;  A[1][1] = 1;  A[2][1] = 0; A[3][1] = 2;
  A[0][2] = 3; A[1][2] = -2;  A[2][2] = 1;  A[3][2] = 4;
...
void glm_transform_test() {
  ...
  mat_Translate = glm::translate(I, glm::vec3(1.0f, -1.0f, 2.0f));
  mat_Rotate = glm::rotate(I, glm::radians(90.0f), glm::normalize(glm::vec3(1.0f, 2.0f, -1.0f)));
  mat_Scale = glm::scale(I, glm::vec3(2.0f, 1.0f, 1.5f));
  mat_LookAt = glm::lookAt(
	  glm::vec3(0.0f, 0.0f, -5.f),
	  glm::vec3(0.0f, 0.0f, 0.0f),
	  glm::vec3(0.0f, 1.0f, 0.0f)
  );
  mat_Ortho = glm::ortho(1.0f, -1.f, 1.f, -1.f, 1.f, -1.f);
